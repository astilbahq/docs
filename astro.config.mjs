      ...
      plugins: [
        ...
        ...(site
          ? [
              starlightLlmsTxt({
                details:
                  "Astilba Create 0.3.0 is released; Astilba Env 0.3.0 is a public alpha; Astilba Cache remains an unreleased preview. Check each product's release or implementation-status page before making availability claims.",
                optionalLinks: [
                  {
