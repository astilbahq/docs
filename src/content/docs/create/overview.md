...
The current release is `create-astilba` 0.1.0. It supports four recipe v1 contracts:
...
| Update or repair an existing generated project | Not in 0.1.0. `doctor` and migration tooling are future work. |
...
| Confirm what 0.1.0 supports | [Release and support](/docs/create/release-and-support/) |
