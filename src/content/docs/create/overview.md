...
The current release is `create-astilba` 0.1.2. It supports four recipe v2 contracts:
...
| Update or repair an existing generated project | Not in 0.1.2. `doctor` and migration tooling are future work. |
...
| Confirm what 0.1.2 supports | [Release and support](/docs/create/release-and-support/) |
