...
- A **negative entry** remembers an opted-in 404 without inventing a value. An invalidation-fresh negative resolves as <code>undefined</code>; it is never served through grace or stale-on-error. Its declared duration is not enforced yet.
