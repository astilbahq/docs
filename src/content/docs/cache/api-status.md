...
This ledger was reviewed against Cache source commit <code>3ba0aa0</code> from 25 July 2026. The Cache repository is not publicly accessible, so the identifier is maintainer provenance rather than a checkout link. Later source changes are not documented here until this snapshot advances.
