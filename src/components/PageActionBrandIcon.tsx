import type { PageActionDestinationId } from "../docs/page-actions";

interface PageActionBrandIconProps {
  className?: string;
  destination: PageActionDestinationId;
}
...
export const PageActionBrandIcon = ({
  className,
  destination,
}: PageActionBrandIconProps) => {
  switch (destination) {
    case "github":
      return (
        <svg
