        ...
        colors: {
          ...
          callout: {
            note: {
              ...
              foreground: themedColor("hsl(234, 100%, 87%)", "hsl(234, 80%, 30%)"),
            },
            tip: {
              accent: themedColor("hsl(281, 82%, 63%)", "hsl(281, 90%, 60%)"),
              foreground: themedColor("hsl(281, 82%, 89%)", "hsl(281, 90%, 30%)"),
            },
            caution: {
            ...
            danger: {
              ...
              foreground: themedColor("hsl(339, 82%, 87%)", "hsl(339, 80%, 30%)"),
            },
          },
        },
        shadows: {
